      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <a href="#home" className="flex items-center gap-2 mb-4" onClick={(e) => {
              e.preventDefault();
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 mb-6 max-w-md">
              A passionate software developer with expertise in both low-level programming and web development technologies.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:ucefsahih@gmail.com" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary-light transition-colors">
                  ucefsahih@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+212708978739" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary-light transition-colors">
                  +212 708 978 739
                </a>
              </li>
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Youssef Sahih. All rights reserved.
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 md:mt-0">
            Designed & Built with <span className="text-red-500">♥</span> by Youssef Sahih
          </p>
        </div>
      </div>
